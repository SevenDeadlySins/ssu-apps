...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Distribution.position'
        db.delete_column(u'key_control_distribution', 'position_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Distribution.position'
        raise RuntimeError("Cannot reverse this migration. 'Distribution.position' and its values cannot be restored.")
