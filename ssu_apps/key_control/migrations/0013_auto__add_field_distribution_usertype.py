...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Distribution.usertype'
        db.add_column(u'key_control_distribution', 'usertype',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['key_control.UserType'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Distribution.usertype'
        db.delete_column(u'key_control_distribution', 'usertype_id')
