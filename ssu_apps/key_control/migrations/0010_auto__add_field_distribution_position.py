...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Distribution.position'
        db.add_column(u'key_control_distribution', 'position',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['key_control.Position'], null=True),
                      keep_default=False)
