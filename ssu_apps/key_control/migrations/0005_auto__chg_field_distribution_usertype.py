...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Distribution.usertype'
        db.alter_column(u'key_control_distribution', 'usertype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['key_control.UserType'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Distribution.usertype'
        raise RuntimeError("Cannot reverse this migration. 'Distribution.usertype' and its values cannot be restored.")
