...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Position.keytype'
        db.add_column(u'key_control_position', 'keytype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='TT1', to=orm['key_control.KeyType']),
                      keep_default=False)
