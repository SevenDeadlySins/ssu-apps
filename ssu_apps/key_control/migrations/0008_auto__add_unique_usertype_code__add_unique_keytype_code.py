...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserType', fields ['code']
        db.create_unique(u'key_control_usertype', ['code'])

        # Adding unique constraint on 'KeyType', fields ['code']
        db.create_unique(u'key_control_keytype', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'KeyType', fields ['code']
        db.delete_unique(u'key_control_keytype', ['code'])

        # Removing unique constraint on 'UserType', fields ['code']
        db.delete_unique(u'key_control_usertype', ['code'])
