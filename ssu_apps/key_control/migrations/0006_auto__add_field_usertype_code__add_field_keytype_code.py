...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserType.code'
        db.add_column(u'key_control_usertype', 'code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4),
                      keep_default=False)

        # Adding field 'KeyType.code'
        db.add_column(u'key_control_keytype', 'code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserType.code'
        db.delete_column(u'key_control_usertype', 'code')

        # Deleting field 'KeyType.code'
        db.delete_column(u'key_control_keytype', 'code')
