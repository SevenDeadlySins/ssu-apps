...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Distribution.date'
        db.alter_column(u'key_control_distribution', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Distribution.date'
        db.alter_column(u'key_control_distribution', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))
