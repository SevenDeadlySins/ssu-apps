...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserType.id'
        db.delete_column(u'key_control_usertype', u'id')


        # Changing field 'UserType.code'
        db.alter_column(u'key_control_usertype', 'code', self.gf('django.db.models.fields.CharField')(max_length=4, primary_key=True))
        # Deleting field 'KeyType.id'
        db.delete_column(u'key_control_keytype', u'id')


        # Changing field 'KeyType.code'
        db.alter_column(u'key_control_keytype', 'code', self.gf('django.db.models.fields.CharField')(max_length=4, primary_key=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserType.id'
        raise RuntimeError("Cannot reverse this migration. 'UserType.id' and its values cannot be restored.")

        # Changing field 'UserType.code'
        db.alter_column(u'key_control_usertype', 'code', self.gf('django.db.models.fields.CharField')(max_length=4, unique=True))

        # User chose to not deal with backwards NULL issues for 'KeyType.id'
        raise RuntimeError("Cannot reverse this migration. 'KeyType.id' and its values cannot be restored.")

        # Changing field 'KeyType.code'
        db.alter_column(u'key_control_keytype', 'code', self.gf('django.db.models.fields.CharField')(max_length=4, unique=True))
