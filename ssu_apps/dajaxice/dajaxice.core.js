...
var Dajaxice = {
    ...
    setSequences: function(callback_function, argv, custom_settings){
        Dajaxice.call('key_control.setSequences', 'POST', callback_function, argv, custom_settings);
    },

    alertTest: function(callback_function, argv, custom_settings){
        Dajaxice.call('key_control.alertTest', 'POST', callback_function, argv, custom_settings);
    }
